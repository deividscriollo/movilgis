            ...
            <div class="col-sm-4">
                <div class="hpanel">
                    <div class="panel-heading">
                        ...
                        Formulario Tipo lugar turístico
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal" id="form-data">
                            <div class="form-group">
                                <label class="col-sm-12 control-label">Nombre Tipo lugar turístico</label>
                                <div class="col-sm-12">
                                    <input type="text" id="txt_1" name="txt_1" class="form-control" placeholder="Nombre Tipo lugar turístico">
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body no-padding">
                    <table class="table table-bordered table-striped" style="clear: both">
                        <tbody>
                        <tr>
                            <td width="35%">Tipo lugar turístico</td>
                            <td width="65%"><a href="" id="username" class="editable editable-click">Tipo lugar turístico</a></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
